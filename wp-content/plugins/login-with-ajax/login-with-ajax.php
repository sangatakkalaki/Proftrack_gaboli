	...
	public static function register(){
	    ...
	    if( get_option('users_can_register') ){
			...
			if ( !is_wp_error($errors) ) {
				...
				$return['result'] = true;
				$return['message'] = __('Registration complete resreshing the page','login-with-ajax');
				
				
			
			//	$return['message'] = __('Registration complete. Please check your e-mail.','login-with-ajax');
			//	$return['message'] = __('Registration complete. Please refresh the page to login.','login-with-ajax');
