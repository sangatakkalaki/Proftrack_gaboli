...
class WP_Email_Template_Functions
{
	...
	public static function replace_shortcode_header ($template_html='', $email_heading='') {
		...
		$header_text_size = 'font-size:30px !important; line-height:34px !important; ';
		
		$header_text_style = 'font-weight:normal !important; font-style:bold !important; ';
		...
		$list_header_shortcode = array(
			...
			'base_colour'								=> '#FFFFFF',
			'base_colour_lighter'						=> WP_Email_Template_Functions::light_or_dark('#FFFFFF', 20),
			'base_colour_light_or_dark'					=> WP_Email_Template_Functions::hex_lighter('#FFFFFF', '#202020', '#ffffff'),
			'header_font'								=> 'Arial, sans-serif',
			'header_text_size'							=> $header_text_size,
			'header_text_style'							=> $header_text_style,
			'header_text_colour'						=> '#1155CC',
	...
	public static function replace_shortcode_footer ($template_html='') {
		...
		$wordpress_email_template_url = '<div style="clear:both"></div>';
